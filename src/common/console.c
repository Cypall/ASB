...
static void display_title(void)
{
	...
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"            ASB (Aegis Support Board)            "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"                _ _ _ _ _ _ _ _ _                "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"               |  _  |  ___|  _  |               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"               | |_| | |___| |_| |               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"               |  _  |_ _  |  _ |                "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"               | | | |___| | |_| |               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"               |_| |_|_ _ _|_ _ _|               "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"                                                 "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"            http://www.asb-sakray.net            "CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_BG_RED""CL_BT_WHITE"                                                 "CL_CLL""CL_NORMAL"\n");

	ShowInfo("ASB %d-bit for %s\n", sysinfo->is64bit() ? 64 : 32, sysinfo->platform());
